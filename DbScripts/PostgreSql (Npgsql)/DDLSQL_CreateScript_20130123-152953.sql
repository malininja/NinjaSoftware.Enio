...
-- Script generated on: 23-sij-2013 15:29.53
--
...
ALTER TABLE "public"."Artikl" DROP CONSTRAINT "FK_268540648c29018a1a754786844";
...
ALTER TABLE "public"."Cjenik" DROP CONSTRAINT "FK_1556ecf466881bc95e2b77cbbc7";
...
ALTER TABLE "public"."Partner" DROP CONSTRAINT "FK_e32220d43c2845753ff91e7e105";
