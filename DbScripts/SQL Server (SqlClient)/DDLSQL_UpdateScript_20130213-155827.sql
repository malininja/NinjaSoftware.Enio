...
ALTER TABLE [dbo].[RacunGlava] DROP COLUMN [StatusId]
GO
...
CREATE TABLE [dbo].[RacunGlavaStatusRo] 
(
	[Code] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL, 
	[Name] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL, 
	[RacunGlavaStatusId] [bigint] NOT NULL 
) ON [PRIMARY]
GO

ALTER TABLE [dbo].[RacunGlava] 
	ADD [RacunGlavaStatusId] [bigint] NOT NULL
GO
...
ALTER TABLE [dbo].[RacunGlavaStatusRo] WITH NOCHECK 
	ADD CONSTRAINT [PK_e73785145d2ac834a719f91799f] PRIMARY KEY CLUSTERED 
	( 
		[RacunGlavaStatusId] 
	) ON [PRIMARY]
GO
...
ALTER TABLE [dbo].[RacunGlava] 
	ADD CONSTRAINT [FK_256837c43f1b0e24c0f679ffa96] FOREIGN KEY
	(
		[RacunGlavaStatusId] 
	)
	REFERENCES [dbo].[RacunGlavaStatusRo]
	(
		[RacunGlavaStatusId] 
	)
GO
