		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		private void SetupSyncEntity(IEntityCore relatedEntity)
		{
			if(_entity!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _entity, new PropertyChangedEventHandler( OnEntityPropertyChanged ), "Entity", NinjaSoftware.Enio.CoolJ.RelationClasses.StaticAuditInfoRelations.EntityRoEntityUsingEntityIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", NinjaSoftware.Enio.CoolJ.RelationClasses.StaticAuditInfoRelations.UserEntityUsingUserIdStatic, true, signalRelatedEntity, "AuditInfoCollection", resetFKFields, new int[] { (int)AuditInfoFieldIndex.UserId } );
			_user = null;
		}
		...
		private void SetupSyncUser(IEntityCore relatedEntity)
		{
			if(_user!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", NinjaSoftware.Enio.CoolJ.RelationClasses.StaticAuditInfoRelations.UserEntityUsingUserIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(AuditInfoActionTypeRoEntityFactory))),	(IEntityRelation)GetRelationsForField("AuditInfoActionType")[0], (int)NinjaSoftware.Enio.CoolJ.EntityType.AuditInfoEntity, (int)NinjaSoftware.Enio.CoolJ.EntityType.AuditInfoActionTypeRoEntity, 0, null, null, null, null, "AuditInfoActionType", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(EntityRoEntityFactory))),	(IEntityRelation)GetRelationsForField("Entity")[0], (int)NinjaSoftware.Enio.CoolJ.EntityType.AuditInfoEntity, (int)NinjaSoftware.Enio.CoolJ.EntityType.EntityRoEntity, 0, null, null, null, null, "Entity", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))),	(IEntityRelation)GetRelationsForField("User")[0], (int)NinjaSoftware.Enio.CoolJ.EntityType.AuditInfoEntity, (int)NinjaSoftware.Enio.CoolJ.EntityType.UserEntity, 0, null, null, null, null, "User", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{ 
			get { return (int)NinjaSoftware.Enio.CoolJ.EntityType.AuditInfoEntity; }
		}
