...
namespace NinjaSoftware.Enio.CoolJ.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
        ...
        {
            SortExpression sort = SortHelper.GetSortExpression(sortField, sortDirection, typeof(TarifaFields));
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<RacunGlavaEntity>(EntityFactoryCache2.GetEntityFactory(typeof(RacunGlavaEntityFactory))), (IEntityRelation)GetRelationsForField("RacunGlavaCollection")[0], (int)NinjaSoftware.Enio.CoolJ.EntityType.TarifaEntity, (int)NinjaSoftware.Enio.CoolJ.EntityType.RacunGlavaEntity, 0, null, null, null, null, "RacunGlavaCollection", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{ 
			get { return (int)NinjaSoftware.Enio.CoolJ.EntityType.TarifaEntity; }
		}
