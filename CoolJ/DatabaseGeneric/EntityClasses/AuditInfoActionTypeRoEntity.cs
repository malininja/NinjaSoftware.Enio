...
namespace NinjaSoftware.Enio.CoolJ.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
			...
			bool isSortAscending)
        {
            ...
            SortExpression sort = SortHelper.GetSortExpression(sortField, sortDirection, typeof(AuditInfoActionTypeRoFields));
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<AuditInfoEntity>(EntityFactoryCache2.GetEntityFactory(typeof(AuditInfoEntityFactory))), (IEntityRelation)GetRelationsForField("AuditInfoCollection")[0], (int)NinjaSoftware.Enio.CoolJ.EntityType.AuditInfoActionTypeRoEntity, (int)NinjaSoftware.Enio.CoolJ.EntityType.AuditInfoEntity, 0, null, null, null, null, "AuditInfoCollection", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{ 
			get { return (int)NinjaSoftware.Enio.CoolJ.EntityType.AuditInfoActionTypeRoEntity; }
		}
