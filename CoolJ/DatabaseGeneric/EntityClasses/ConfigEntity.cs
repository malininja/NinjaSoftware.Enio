...
namespace NinjaSoftware.Enio.CoolJ.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
			...
			bool isSortAscending)
        {
            ...
            Type sortEntityFieldType = typeof(ConfigFields);
		...
		public ConfigEntity():base("ConfigEntity")
		{
		...
		public ConfigEntity(IEntityFields2 fields):base("ConfigEntity")
		{
		...
		public ConfigEntity(IValidator validator):base("ConfigEntity")
		{
		...
		{
			return new ConfigRelations().GetAllRelations();
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(ConfigEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("AktivnaGodina", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
			...
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("Zr", fieldHashtable);
		}
		#endregion

		/// <summary> Initializes the class with empty data, as if it is a new Entity.</summary>
		/// <param name="validator">The validator object for this ConfigEntity</param>
		...
		public  static ConfigRelations Relations
		{
			get	{ return new ConfigRelations(); }
		}
		...
		public virtual System.String Adresa
		{
			...
			set	{ SetValue((int)ConfigFieldIndex.Adresa, value); }
		}
		...
		public virtual System.Int16 AktivnaGodina
		{
			...
			set	{ SetValue((int)ConfigFieldIndex.AktivnaGodina, value); }
		}
		...
		public virtual System.String Mjesto
		{
			...
			set	{ SetValue((int)ConfigFieldIndex.Mjesto, value); }
		}
		...
		public virtual System.String Naziv
		{
			...
			set	{ SetValue((int)ConfigFieldIndex.Naziv, value); }
		}
		...
		public virtual System.String Oib
		{
			...
			set	{ SetValue((int)ConfigFieldIndex.Oib, value); }
		}
		...
		public virtual System.String Zr
		{
			...
			set	{ SetValue((int)ConfigFieldIndex.Zr, value); }
		}
