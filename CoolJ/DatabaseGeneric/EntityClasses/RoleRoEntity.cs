...
namespace NinjaSoftware.Enio.CoolJ.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected RoleRoEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
			...
			{
				_korisnikCollection = (EntityCollection<KorisnikEntity>)info.GetValue("_korisnikCollection", typeof(EntityCollection<KorisnikEntity>));
		...
		protected override void SetRelatedEntityProperty(string propertyName, IEntityCore entity)
		{
			switch(propertyName)
			{
				case "KorisnikCollection":
					this.KorisnikCollection.Add((KorisnikEntity)entity);
					break;
				default:
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "KorisnikCollection":
					toReturn.Add(Relations.KorisnikEntityUsingRoleId);
					break;
				default:
					break;				
			}
		...
		protected override void SetRelatedEntity(IEntityCore relatedEntity, string fieldName)
		{
			...
			{
				case "KorisnikCollection":
					this.KorisnikCollection.Add((KorisnikEntity)relatedEntity);
					break;
				default:
					break;
			}
		...
		/// <summary> Creates a new IRelationPredicateBucket object which contains the predicate expression and relation collection to fetch the related entities of type 'Korisnik' to this entity.</summary>
		/// <returns></returns>
		public virtual IRelationPredicateBucket GetRelationInfoKorisnikCollection()
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(KorisnikFields.RoleId, null, ComparisonOperator.Equal, this.RoleId));
			return bucket;
		}
		...
		protected override void GetFromMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue)
		{
			...
			this._korisnikCollection = (EntityCollection<KorisnikEntity>) collectionsQueue.Dequeue();
		...
		protected override void CreateMemberEntityCollectionsQueue(Queue<IEntityCollection2> collectionsQueue, Queue<bool> requiredQueue) 
		{
			...
			collectionsQueue.Enqueue(requiredQueue.Dequeue() ? new EntityCollection<KorisnikEntity>(EntityFactoryCache2.GetEntityFactory(typeof(KorisnikEntityFactory))) : null);
		}
#endif
		...
		/// <summary> Creates a new PrefetchPathElement2 object which contains all the information to prefetch the related entities of type 'Korisnik' for this entity.</summary>
		...
		/// <summary> Gets the EntityCollection with the related entities of type 'KorisnikEntity' which are related to this entity via a relation of type '1:n'. If the EntityCollection hasn't been fetched yet, the collection returned will be empty.<br/><br/></summary>
		[TypeContainedAttribute(typeof(KorisnikEntity))]
		public virtual EntityCollection<KorisnikEntity> KorisnikCollection
		{
			get { return GetOrCreateEntityCollection<KorisnikEntity, KorisnikEntityFactory>("Role", true, false, ref _korisnikCollection);	}
		}
