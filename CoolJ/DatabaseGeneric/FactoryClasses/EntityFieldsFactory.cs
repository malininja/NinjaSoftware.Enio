...
namespace NinjaSoftware.Enio.CoolJ.FactoryClasses
{
	...
	{
		private static readonly Dictionary<NinjaSoftware.Enio.CoolJ.EntityType, string> _entityTypeNamesCache = new Dictionary<NinjaSoftware.Enio.CoolJ.EntityType, string>();

		/// <summary>static ctor which initializes the static entity type cache.</summary>
		static EntityFieldsFactory()
		{
			foreach(NinjaSoftware.Enio.CoolJ.EntityType value in Enum.GetValues(typeof(NinjaSoftware.Enio.CoolJ.EntityType)))
			{
				_entityTypeNamesCache.Add(value, Enum.GetName(typeof(NinjaSoftware.Enio.CoolJ.EntityType), value));
			}
		}	
