...
namespace NinjaSoftware.Enio.FactoryClasses
{
	...
	{
		private static readonly Dictionary<NinjaSoftware.Enio.EntityType, string> _entityTypeNamesCache = new Dictionary<NinjaSoftware.Enio.EntityType, string>();

		/// <summary>static ctor which initializes the static entity type cache.</summary>
		static EntityFieldsFactory()
		{
			foreach(NinjaSoftware.Enio.EntityType value in Enum.GetValues(typeof(NinjaSoftware.Enio.EntityType)))
			{
				_entityTypeNamesCache.Add(value, Enum.GetName(typeof(NinjaSoftware.Enio.EntityType), value));
			}
		}	
		...
		public static IEntityFields2 CreateEntityFieldsObject(NinjaSoftware.Enio.EntityType relatedEntityType)
		{
