...
namespace NinjaSoftware.Enio.RelationClasses
{
	...
	public partial class RoleRoRelations
	{
		...
		public virtual List<IEntityRelation> GetAllRelations()
		{
			...
			toReturn.Add(this.KorisnikEntityUsingRoleId);
			return toReturn;
		}

		#region Class Property Declarations

		/// <summary>Returns a new IEntityRelation object, between RoleRoEntity and KorisnikEntity over the 1:n relation they have, using the relation between the fields:
		/// RoleRo.RoleId - Korisnik.RoleId
		/// </summary>
		public virtual IEntityRelation KorisnikEntityUsingRoleId
		{
			get
			{
				...
				relation.InheritanceInfoFkSideEntity = InheritanceInfoProviderSingleton.GetInstance().GetInheritanceInfo("KorisnikEntity", false);
				return relation;
			}
		}
	...
	{
		internal static readonly IEntityRelation KorisnikEntityUsingRoleIdStatic = new RoleRoRelations().KorisnikEntityUsingRoleId;
