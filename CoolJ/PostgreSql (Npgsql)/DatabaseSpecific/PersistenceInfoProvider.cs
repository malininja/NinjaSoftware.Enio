...
namespace NinjaSoftware.Enio.CoolJ.PostgreSql.DatabaseSpecific
{
	...
	internal class PersistenceInfoProviderCore : PersistenceInfoProviderBase
	{
		...
		{
			this.AddElementMapping( "AuditInfoEntity", @"Default", @"public", "AuditInfo", 8 );
		...
		{
			this.AddElementMapping( "AuditInfoActionTypeRoEntity", @"Default", @"public", "AuditInfoActionTypeRo", 3 );
		...
		{
			this.AddElementMapping( "EntityRoEntity", @"Default", @"public", "EntityRo", 3 );
		...
		{
			this.AddElementMapping( "UserEntity", @"Default", @"public", "User", 5 );
			...
			this.AddElementFieldMapping( "UserEntity", "UserId", "UserId", false, "Bigint", 0, 0, 19, true, "public.GenericSequence", null, typeof(System.Int64), 3 );
