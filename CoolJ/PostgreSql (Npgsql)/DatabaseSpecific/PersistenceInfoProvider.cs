...
namespace NinjaSoftware.Enio.PostgreSql.DatabaseSpecific
{
	...
	internal class PersistenceInfoProviderCore : PersistenceInfoProviderBase
	{
		...
		private void InitArtiklEntityMappings()
		{
			...
			this.AddElementFieldMapping( "ArtiklEntity", "Jm", "Jm", false, "Varchar", 10, 0, 0, false, "", null, typeof(System.String), 2 );
			this.AddElementFieldMapping( "ArtiklEntity", "Naziv", "Naziv", false, "Varchar", 100, 0, 0, false, "", null, typeof(System.String), 3 );
			this.AddElementFieldMapping( "ArtiklEntity", "Pdv", "Pdv", false, "Numeric", 0, 2, 4, false, "", null, typeof(System.Decimal), 4 );
		...
		{
			this.AddElementMapping( "BrojacEntity", @"Default", @"public", "Brojac", 5 );
			this.AddElementFieldMapping( "BrojacEntity", "BrojacId", "BrojacId", false, "Bigint", 0, 0, 19, true, "public.GenericSequence", null, typeof(System.Int64), 0 );
		...
		{
			this.AddElementMapping( "ConfigEntity", @"Default", @"public", "Config", 7 );
			...
			this.AddElementFieldMapping( "ConfigEntity", "Mjesto", "Mjesto", true, "Varchar", 100, 0, 0, false, "", null, typeof(System.String), 3 );
			this.AddElementFieldMapping( "ConfigEntity", "Naziv", "Naziv", false, "Varchar", 100, 0, 0, false, "", null, typeof(System.String), 4 );
			this.AddElementFieldMapping( "ConfigEntity", "Oib", "Oib", false, "Varchar", 11, 0, 0, false, "", null, typeof(System.String), 5 );
			this.AddElementFieldMapping( "ConfigEntity", "Zr", "Zr", true, "Varchar", 50, 0, 0, false, "", null, typeof(System.String), 6 );
		}
		/// <summary>Inits KorisnikEntity's mappings</summary>
		private void InitKorisnikEntityMappings()
		{
			this.AddElementMapping( "KorisnikEntity", @"Default", @"public", "Korisnik", 5 );
			this.AddElementFieldMapping( "KorisnikEntity", "ConcurrencyGuid", "ConcurrencyGuid", false, "Varchar", 50, 0, 0, false, "", null, typeof(System.String), 0 );
			this.AddElementFieldMapping( "KorisnikEntity", "KorisnikId", "KorisnikId", false, "Bigint", 0, 0, 19, true, "public.GenericSequence", null, typeof(System.Int64), 1 );
			this.AddElementFieldMapping( "KorisnikEntity", "Password", "Password", false, "Varchar", 50, 0, 0, false, "", null, typeof(System.String), 2 );
			this.AddElementFieldMapping( "KorisnikEntity", "RoleId", "RoleId", false, "Bigint", 0, 0, 19, false, "", null, typeof(System.Int64), 3 );
			this.AddElementFieldMapping( "KorisnikEntity", "Username", "Username", false, "Varchar", 20, 0, 0, false, "", null, typeof(System.String), 4 );
		}
		/// <summary>Inits PartnerEntity's mappings</summary>
		private void InitPartnerEntityMappings()
		{
			this.AddElementMapping( "PartnerEntity", @"Default", @"public", "Partner", 9 );
			...
			this.AddElementFieldMapping( "PartnerEntity", "Mjesto", "Mjesto", true, "Varchar", 20, 0, 0, false, "", null, typeof(System.String), 2 );
			this.AddElementFieldMapping( "PartnerEntity", "Naziv", "Naziv", false, "Varchar", 100, 0, 0, false, "", null, typeof(System.String), 3 );
			this.AddElementFieldMapping( "PartnerEntity", "Oib", "Oib", false, "Varchar", 11, 0, 0, false, "", null, typeof(System.String), 4 );
			this.AddElementFieldMapping( "PartnerEntity", "PartnerId", "PartnerId", false, "Bigint", 0, 0, 19, true, "public.GenericSequence", null, typeof(System.Int64), 5 );
			this.AddElementFieldMapping( "PartnerEntity", "Posta", "Posta", true, "Varchar", 10, 0, 0, false, "", null, typeof(System.String), 6 );
		...
		{
			this.AddElementMapping( "RacunGlavaEntity", @"Default", @"public", "RacunGlava", 11 );
			this.AddElementFieldMapping( "RacunGlavaEntity", "ConcurrencyGuid", "ConcurrencyGuid", false, "Varchar", 50, 0, 0, false, "", null, typeof(System.String), 0 );
			this.AddElementFieldMapping( "RacunGlavaEntity", "Datum", "Datum", false, "Date", 0, 0, 0, false, "", null, typeof(System.DateTime), 1 );
			this.AddElementFieldMapping( "RacunGlavaEntity", "Godina", "Godina", false, "Smallint", 0, 0, 0, false, "", null, typeof(System.Int16), 2 );
			this.AddElementFieldMapping( "RacunGlavaEntity", "MjestoRadaAdresa", "MjestoRadaAdresa", true, "Varchar", 100, 0, 0, false, "", null, typeof(System.String), 3 );
			this.AddElementFieldMapping( "RacunGlavaEntity", "MjestoRadaNaziv", "MjestoRadaNaziv", true, "Varchar", 100, 0, 0, false, "", null, typeof(System.String), 4 );
			this.AddElementFieldMapping( "RacunGlavaEntity", "PartnerId", "PartnerId", false, "Bigint", 0, 0, 19, false, "", null, typeof(System.Int64), 5 );
			this.AddElementFieldMapping( "RacunGlavaEntity", "RacunGlavaId", "RacunGlavaId", false, "Bigint", 0, 0, 19, true, "public.GenericSequence", null, typeof(System.Int64), 6 );
			...
			this.AddElementFieldMapping( "RacunGlavaEntity", "TarifaStopa", "TarifaStopa", false, "Numeric", 0, 2, 5, false, "", null, typeof(System.Decimal), 9 );
			this.AddElementFieldMapping( "RacunGlavaEntity", "Valuta", "Valuta", false, "Smallint", 0, 0, 0, false, "", null, typeof(System.Int16), 10 );
		}
		/// <summary>Inits RacunStavkaEntity's mappings</summary>
		private void InitRacunStavkaEntityMappings()
		{
			this.AddElementMapping( "RacunStavkaEntity", @"Default", @"public", "RacunStavka", 11 );
			this.AddElementFieldMapping( "RacunStavkaEntity", "ArtiklId", "ArtiklId", false, "Bigint", 0, 0, 19, false, "", null, typeof(System.Int64), 0 );
			this.AddElementFieldMapping( "RacunStavkaEntity", "Cijena", "Cijena", false, "Numeric", 0, 2, 10, false, "", null, typeof(System.Decimal), 1 );
			...
			this.AddElementFieldMapping( "RacunStavkaEntity", "Iznos", "Iznos", false, "Numeric", 0, 2, 10, false, "", null, typeof(System.Decimal), 3 );
			this.AddElementFieldMapping( "RacunStavkaEntity", "Kolicina", "Kolicina", false, "Numeric", 0, 2, 8, false, "", null, typeof(System.Decimal), 4 );
			this.AddElementFieldMapping( "RacunStavkaEntity", "PdvIznos", "PdvIznos", false, "Numeric", 0, 2, 10, false, "", null, typeof(System.Decimal), 5 );
			this.AddElementFieldMapping( "RacunStavkaEntity", "PdvPosto", "PdvPosto", false, "Numeric", 0, 2, 4, false, "", null, typeof(System.Decimal), 6 );
			...
			this.AddElementFieldMapping( "RacunStavkaEntity", "RacunStavkaId", "RacunStavkaId", false, "Bigint", 0, 0, 19, true, "public.GenericSequence", null, typeof(System.Int64), 9 );
			this.AddElementFieldMapping( "RacunStavkaEntity", "TarifaIznos", "TarifaIznos", false, "Numeric", 0, 2, 10, false, "", null, typeof(System.Decimal), 10 );
		}
		/// <summary>Inits RoleRoEntity's mappings</summary>
		private void InitRoleRoEntityMappings()
		{
			this.AddElementMapping( "RoleRoEntity", @"Default", @"public", "RoleRo", 3 );
		...
		{
			this.AddElementMapping( "StatusRoEntity", @"Default", @"public", "StatusRo", 3 );
		...
		{
			this.AddElementMapping( "TarifaEntity", @"Default", @"public", "Tarifa", 5 );
			...
			this.AddElementFieldMapping( "TarifaEntity", "Naziv", "Naziv", false, "Varchar", 100, 0, 0, false, "", null, typeof(System.String), 1 );
			this.AddElementFieldMapping( "TarifaEntity", "StatusId", "StatusId", false, "Bigint", 0, 0, 19, false, "", null, typeof(System.Int64), 2 );
			this.AddElementFieldMapping( "TarifaEntity", "Stopa", "Stopa", false, "Numeric", 0, 2, 5, false, "", null, typeof(System.Decimal), 3 );
			this.AddElementFieldMapping( "TarifaEntity", "TarifaId", "TarifaId", false, "Bigint", 0, 0, 19, true, "public.GenericSequence", null, typeof(System.Int64), 4 );
		}
